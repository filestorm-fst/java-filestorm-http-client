...
//
//    private final Fstorm ipfs = new Fstorm(new MultiAddress("/ip4/127.0.0.1/tcp/5001"));
...
//        Map<Multihash, Object> ls1 = ipfs.pin.ls(Fstorm.PinType.all);
...
//        Map<Multihash, Object> ls = ipfs.pin.ls(Fstorm.PinType.recursive);
//        ipfs.repo.gc();
//        // object should still be present after gc
//        Map<Multihash, Object> ls2 = ipfs.pin.ls(Fstorm.PinType.recursive);
...
//
//        Map<Multihash, Object> ls = ipfs.pin.ls(Fstorm.PinType.all);
//        boolean childPresent = ls.containsKey(hashChild1);
//        if (!childPresent)
//            throw new IllegalStateException("Child not present!");
//
//        ipfs.repo.gc();
//        Map<Multihash, Object> ls2 = ipfs.pin.ls(Fstorm.PinType.all);
...
//        Fstorm ipfs = new Fstorm(new MultiAddress("/ip4/127.0.0.1/tcp/5001")).timeout(1000);
